...
My friend, [Dustin Younse](https://x.com/milsyobtaf), recommended I look into [brotli](https://github.com/google/brotli), a generic-purpose lossless compression algorithm developed by Google, as a possible solution for further file shrinking.
