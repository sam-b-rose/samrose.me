...
We are use `React.forwardRef` to automatically pass a `ref` through to our root Box component. This allows users of these foundational components to obtain a `ref` to the inner DOM element if needed.
