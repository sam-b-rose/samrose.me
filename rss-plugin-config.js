        ...
        serialize: ({ query: { site, allMdx } }) => {
          const data = allMdx.edges
            ...
            .map((edge) => {
              ...
              if (interactive) {
                html = `<div style="margin-top: 50px; font-style: italic;">This post features interactive elements, and cannot be displayed in an RSS reader. <strong><a href="${postUrl}">View it on samrose.me</a></strong>.</div>`;
              } else {
